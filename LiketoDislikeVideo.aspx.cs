...
using System.Configuration;
    ...
    public partial class LiketoDislikeVideo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(Request.QueryString["VideoID"] != null)
            {
                ...
                con.Open();
                String UpdateVote = "UPDATE [dbo].[Video] SET TotalLike = @like, TotalDislike = @dislike WHERE VideoID ="+video;
                SqlCommand com = new SqlCommand(UpdateVote,con);
                SqlParameter getLike = new SqlParameter("@like",like);
                ...
                con.Close();
                con1.Open();
                String InsertVote = "INSERT INTO [dbo].[Vote] (UserID,VideoID,VoteLike,VoteDislike) VALUES (@user,@video,'0','1')";

...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPendingVideo.aspx.cs" Inherits="ViewPendingVideo" %>
...
<tr><td><pre></pre></td></tr>
     ...
     <asp:Button ID="ApproveBtn" style="font-size:16px" class = "SbmtBtn" runat="server" Text="Approve" OnClick="ApproveBtn_Click" ></asp:Button>  <asp:Button ID="DeclineBtn" class = "SbmtBtn" runat="server" Text="Reject" style="font-size:16px" OnClick="DeclineBtn_Click" ></asp:Button>
     </center>   
